      ...
      <div className="max-w-2xl mx-auto bg-white shadow-md rounded-2xl p-6 space-y-6">
        ...
        <div className="border-t border-gray-200 pt-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <select className="border border-gray-200 text-gray-600 rounded px-3 py-2 min-w-[140px]">
        ...
        <div className="space-y-2 border-t border-gray-200 pt-6">
          ...
          <p className="text-sm text-gray-500">Customize your application appearance</p>
        ...
        <div className="grid grid-cols-2 items-center border-t border-gray-200 pt-6">
          ...
          <div className="flex justify-end space-x-3">
            {['bg-red-400','bg-yellow-400','bg-green-300','bg-blue-800','bg-pink-400'].map((color, i) => (
              <div key={i} className={`${color} w-6 h-6 rounded-full cursor-pointer hover:scale-110 transition`} />
            ))}
          </div>
        </div>
        ...
        <div className="space-y-4 border-t border-gray-200 pt-2">
          {[
            ...
            <label
              key={i}
              className={`flex items-center justify-between pt-4 ${i > 0 ? 'border-t border-gray-200' : ''}`}
            >
        ...
        <div className="flex justify-between border-t border-gray-200 pt-6">
          ...
          <div className="space-x-2">
            <button className="px-4 py-2 border border-gray-200 rounded-2xl hover:bg-gray-100">Cancel</button>
            <button className="px-4 py-2 bg-blue-800 text-white rounded-2xl hover:bg-violet-700">Save Preferences</button>
          </div>
        </div>
      </div>
    </main>
